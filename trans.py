...
# voice label
lab_txt = Label(root, text="Voice", font=("Time New Roman", 11, "bold"), bg="lightgray")
lab_txt.place(x=25, y=325, width=350, height=30)

# speed label
lab_txt = Label(root, text="Gender", font=("Time New Roman", 11, "bold"), bg="lightgray")
...
sor_txt = Text(frame, font=("Time New Roman", 15), wrap=WORD, bg="white", fg="black", borderwidth=2, relief="groove")
sor_txt.place(x=25, y=115, height=115, width=350)

# Frame for destination text for language converted
frame = Frame(root).pack(side=BOTTOM)
dest_txt = Text(frame, font=("Time New Roman", 15), wrap=WORD, bg="white", fg="black", borderwidth=2, relief="groove")
...
button_change = Button(frame, text="Translate", relief=RAISED, command=data, bg="teal", fg="white")
button_change.place(x=325, y=290, width=115, height=28)

# button for speak
button_speak = Button(frame, text="Speak", relief=RAISED, bg="teal", fg="white", command=speaknow)
button_speak.place(x=25, y=400, width=350, height=28)

# download button
button_down = Button(frame, text="Download", relief=RAISED, bg="teal", fg="white", command=download)
